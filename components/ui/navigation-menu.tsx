...
function NavigationMenuViewport({
  ...
  return (
    <div
      className="absolute top-full left-1/2 -translate-x-1/2 isolate z-50 flex justify-center perspective-[2000px]"
    >
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        forceMount
        className={cn(
          'origin-top bg-popover text-popover-foreground relative mt-1.5 overflow-hidden rounded-md border shadow',
